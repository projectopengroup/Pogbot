...
"""
This code originates from music_bot_example.py a discord music bot example Copyright (c) 2019 Valentin B.
"""
...
class Song:
    ...
    def create_embed(self):
        embed = (discord.Embed(title='<:youtube:857435284013973504> Now playing',
...
class Music(commands.Cog, name="Music"):
    ...
    @commands.command(name='summon', brief='Moves bot to your channel.',
                      description='Forces the bot to join your channel.')
    ...
    @commands.command(name='leave', aliases=['disconnect', 'dc'], brief='Disconnects the bot.',
    ...
    @commands.command(name='volume', brief='Adjusts volume.', description='Sets the volume of the bot media.')
    ...
    @commands.command(name='now', aliases=['current', 'playing', 'np'], brief='Displays the song playing.',
                      description="Displays the current song that's playing.")
    ...
    @commands.command(name='resume', brief='Resumes the currently paused song.',
    ...
    @commands.command(name='skip', brief='Skips the current song.',
                      description='Skips the currently playing song, requires at least 3 votes.')
    ...
    @commands.command(name='queue', aliases=['q'], brief='Displays the song queue.',
                      description='Displays the current song queue by page.')
    ...
    @commands.command(name='remove', brief='Remove a song from the queue at index.',
                      description='Removes a song from the queue at the given index.')
        ...
        async with ctx.typing():
            try:
                ...
                await send_embed(ctx, send_option=0,
                                 description=f"<:Check:845178458426179605> **Added {str(source)} to the queue.**",
                                 color=0x08d5f7)
                # wait ctx.send(f'Added  {}'.format(str(source)))
